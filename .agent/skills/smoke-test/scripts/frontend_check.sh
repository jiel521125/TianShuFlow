...
# When the gateway has authentication enabled (TIAN_SHU_AUTH_DISABLED != 1),
...
SMOKE_TEST_EMAIL="${SMOKE_TEST_EMAIL:-smoke-test@tianshu.dev}"
SMOKE_TEST_PASSWORD="${SMOKE_TEST_PASSWORD:-SmokeTest123!}"
COOKIE_JAR=$(mktemp /tmp/tianshu-smoke-cookies.XXXXXX)
