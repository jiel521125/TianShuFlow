...
|----------|------|----------|
| tian-shu-nginx | {{nginx_status}} | {{nginx_uptime}} |
| tian-shu-frontend | {{frontend_status}} | {{frontend_uptime}} |
| tian-shu-gateway | {{gateway_status}} | {{gateway_uptime}} |
...
### If the Test Passes
1. [ ] Visit http://localhost:2026 to start using TianShu
