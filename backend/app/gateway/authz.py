"""Authorization decorators and context for TianShu.
...
from tianshu.authz.provider import AuthorizationProvider, AuthzDecision, AuthzRequest, Principal
...
def _make_test_request_stub() -> Any:
    ...
    """
    return SimpleNamespace(state=SimpleNamespace(), cookies={}, _tianshu_test_bypass_auth=True)
...
def require_auth[**P, T](func: Callable[P, T]) -> Callable[P, T]:
    ...
    async def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        if getattr(request, "_tianshu_test_bypass_auth", False):
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            if owner_check:
                ...
                if not allowed and getattr(auth.user, "system_role", None) == INTERNAL_SYSTEM_ROLE:
                    ...
                    # the connection owner carried in X-TianShu-Owner-User-Id.
