...
from tianshu.agents.lead_agent.prompt import refresh_skills_system_prompt_cache_async
from tianshu.config.app_config import AppConfig
from tianshu.integrations.lark_cli import (
...
class LarkCliProbeResponse(BaseModel):
    available: bool = Field(..., description="Whether lark-cli is available to the Gateway, either managed by TianShu or on PATH")
