...
:func:`tianshu.runtime.serialization.serialize_channel_values` to
...
from tianshu.agents.thread_state import THREAD_STATE_REDUCER_FIELDS
from tianshu.config.paths import Paths, get_paths
from tianshu.config.summarization_config import ContextSize
from tianshu.persistence.thread_meta import THREAD_PINNED_METADATA_KEY
from tianshu.runtime import serialize_channel_values_for_api
from tianshu.runtime.checkpoint_mode import CheckpointModeMismatchError, CheckpointModeReconfigurationError
from tianshu.runtime.checkpoint_state import graph_reducer_channels, graph_state_schema, graph_writable_channels
from tianshu.runtime.context_compaction import (
...
from tianshu.runtime.journal import build_branch_history_seed_events
from tianshu.runtime.runs.manager import ConflictError
from tianshu.runtime.runs.worker import valid_duration_entry
from tianshu.runtime.secret_context import redact_metadata_secrets
from tianshu.runtime.user_context import get_effective_user_id
from tianshu.utils.file_io import run_file_io
from tianshu.utils.thread_id import ThreadId, resolve_thread_id, validate_thread_id
from tianshu.utils.time import coerce_iso, now_iso
...
_SIDECAR_METADATA_KEY = "tianshu_sidecar"
_BRANCH_METADATA_KEY = "tianshu_branch"
...
class ThreadSearchRequest(BaseModel):
    ...
    def _validate_metadata_filters(cls, v: dict[str, Any]) -> dict[str, Any]:
        ...
        See ``tianshu.persistence.json_compat`` for the shared validators.
        """
        if not v:
            return v
        from tianshu.persistence.json_compat import validate_metadata_filter_key, validate_metadata_filter_value
...
async def delete_thread_data(thread_id: str, request: Request) -> ThreadDeleteResponse:
    ...
    Cleans TianShu-managed thread directories, removes checkpoint data,
    ...
    # Remove thread_meta row (best-effort) — required for the SQL backend
    ...
    try:
        from tianshu.community.browser_automation import get_browser_session_manager
...
async def search_threads(body: ThreadSearchRequest, request: Request) -> list[ThreadResponse]:
    ...
    (SQL-backed for postgres, Store-backed for memory mode).
    """
    from app.gateway.deps import get_thread_store
    from tianshu.persistence.thread_meta import InvalidMetadataFilterError
                ...
                if messages:
                    ...
                    try:
                        ...
                        if missing_run_ids:
                            ...
                            from tianshu.runtime.runs.worker import persist_run_durations
