...
from tianshu.config.paths import VIRTUAL_PATH_PREFIX, get_paths
...
from tianshu.uploads.manager import UnsafeUploadPathError, claim_unique_filename, normalize_filename, write_upload_file_no_symlink
        ...
        async with httpx.AsyncClient(timeout=httpx.Timeout(30.0)) as client:
            response = await client.post(
                ...
                json={
                    ...
                    "msgParam": json.dumps({"title": "TianShu", "text": text}),
                    "robotCode": robot_code,
                    "userIds": [user_id],
                },
            )
