...
from tianshu.persistence.scheduled_task_runs import ActiveScheduledRunConflict
from tianshu.runtime import ConflictError, RunRecord
from tianshu.scheduler.schedules import next_run_at
    ...
    async def _run_loop(self) -> None:
        while not self._stop.is_set():
            try:
                ...
                # A transient DB error (e.g. a deadlocked or lost connection)
                # must not kill the poller task for the rest of the process life.
