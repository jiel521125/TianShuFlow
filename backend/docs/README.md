...
This directory contains detailed documentation for the TianShu backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs TianShuClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to TianShu?** Start with [SETUP.md](SETUP.md) for quick installation
