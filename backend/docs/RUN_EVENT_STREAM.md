...
The run event stream is TianShu's append-only record of what happened during
...
categories live in `tianshu.runtime.events.catalog`; conformance tests require
