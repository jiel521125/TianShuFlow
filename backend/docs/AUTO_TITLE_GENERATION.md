...
{
  "graphs": {
    "lead_agent": "tianshu.agents:lead_agent"
  },
...
```python
from tianshu.config.title_config import TitleConfig, set_title_config
...
- [`packages/harness/tianshu/agents/thread_state.py`](../packages/harness/tianshu/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/tianshu/agents/middlewares/title_middleware.py`](../packages/harness/tianshu/agents/middlewares/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/tianshu/config/title_config.py`](../packages/harness/tianshu/config/title_config.py) - 配置管理
- [`config.yaml`](../../config.example.yaml) - 配置文件
- [`packages/harness/tianshu/agents/lead_agent/agent.py`](../packages/harness/tianshu/agents/lead_agent/agent.py) - Middleware 注册
