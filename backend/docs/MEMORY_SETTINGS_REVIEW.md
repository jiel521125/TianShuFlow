...
1. Start TianShu locally using any working development setup you already use.
   ...
   If you already have TianShu running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.tian-shu/memory.json`
