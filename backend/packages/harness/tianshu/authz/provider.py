...
deliberately kept as a sibling to :mod:`tianshu.guardrails` rather than folded
...
2. **Run-time execution deny** — reuses :class:`~tianshu.guardrails.middleware.GuardrailMiddleware`
   via a thin adapter (see :mod:`tianshu.authz.adapter`), catching dynamic
...
class AuthorizationProvider(Protocol):
    ...
    mechanism TianShu uses for models, tools, sandbox, and guardrails.
