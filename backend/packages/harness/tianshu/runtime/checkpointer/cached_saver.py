...
from tianshu.runtime.checkpoint_cache.base import make_history_key
...
class CachedHistorySaver(BaseCheckpointSaver):
    ...
    def __getattr__(self, name: str) -> Any:
        # Safety net for saver-specific extras (e.g. async saver setup).
    ...
    async def _aresolve(self, tup: CheckpointTuple, channel: str, depth: int) -> dict[str, Any]:
        ...
        compose on a 500-step postgres run). Recursing one level per
