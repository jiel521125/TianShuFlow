...
from tianshu.utils.messages import message_to_text, restore_original_human_message
...
class RunJournal(BaseCallbackHandler):
    ...
    def _flush_sync(self) -> None:
        ...
        # to the backing store from multiple fire-and-forget tasks.
