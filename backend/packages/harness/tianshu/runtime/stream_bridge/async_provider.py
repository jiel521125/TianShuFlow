...
Usage (e.g. FastAPI lifespan)::
    ...
    from tianshu.agents.stream_bridge import make_stream_bridge
...
from tianshu.config.stream_bridge_config import StreamBridgeConfig, get_stream_bridge_config

from .base import StreamBridge

logger = logging.getLogger(__name__)

_ENV_REDIS_URL = "TIAN_SHU_STREAM_BRIDGE_REDIS_URL"
