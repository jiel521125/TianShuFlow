...
from tianshu.sandbox.local.list_dir import list_dir
...
class LocalSandbox(Sandbox):
    ...
    def _reverse_output_patterns(self) -> list[re.Pattern[str]]:
        ...
        # ``tianshu.sandbox.path_patterns`` and shared with
    ...
    def _run_posix_command(
        ...
        stdout_capture, stdout_thread = LocalSandbox._start_pipe_drain(stdout_read_fd, "tianshu-bash-stdout-drain")
        stderr_capture, stderr_thread = LocalSandbox._start_pipe_drain(stderr_read_fd, "tianshu-bash-stderr-drain")
        try:
