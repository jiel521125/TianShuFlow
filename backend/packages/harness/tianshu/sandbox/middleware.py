...
from tianshu.agents.thread_state import SandboxStateField, ThreadDataState
from tianshu.runtime.user_context import resolve_runtime_user_id
from tianshu.sandbox import get_sandbox_provider
...
class SandboxMiddleware(AgentMiddleware[SandboxMiddlewareState]):
    ...
    #
    # Background:
    #   ``ensure_sandbox_initialized*`` in ``tianshu.sandbox.tools`` mutates
