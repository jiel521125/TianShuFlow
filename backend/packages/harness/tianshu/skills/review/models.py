...
PACKAGE_SNAPSHOT_SCHEMA_VERSION = "tianshu.skill-package-snapshot.v1"
FACTS_SCHEMA_VERSION = "tianshu.skill-review.facts.v1"
REPORT_SCHEMA_VERSION = "tianshu.skill-review.report.v1"

Severity = Literal["blocker", "error", "warning", "info"]
ProfileName = Literal["tianshu", "agentskills"]
