...
from tianshu.skills.review.models import DEFAULT_PACKAGE_LIMITS, SEVERITY_RANK, PackageLimits, stable_json_dumps
from tianshu.skills.review.readers import ArchivePackageReader, LocalDirectoryReader
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--profile", choices=["tianshu", "agentskills"], default="tianshu")
