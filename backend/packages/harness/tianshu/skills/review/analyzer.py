...
from tianshu.skills.frontmatter import ALLOWED_FRONTMATTER_PROPERTIES, split_skill_markdown
from tianshu.skills.package_paths import is_eval_fixture_path, is_eval_fixture_skill_md
from tianshu.skills.parser import parse_allowed_tools, parse_required_secrets
from tianshu.skills.review.digest import compute_package_digest
from tianshu.skills.review.eval_schema import analyze_eval_manifests
from tianshu.skills.review.models import (
...
from tianshu.skills.review.resource_graph import build_resource_graph
from tianshu.skills.skillscan.orchestrator import scan_skill_dir


def analyze_skill_package(snapshot: dict[str, Any], *, profile: ProfileName = "tianshu") -> dict[str, Any]:
    ...
    if unexpected:
        findings.append(
            make_finding(
                ...
                remediation="Remove unsupported fields or add them to the shared TianShu frontmatter schema.",
                evidence=unexpected,
            )
        )
    ...
    if not isinstance(description, str) or not description.strip():
        ...
        findings.append(
            make_finding(
                ...
                severity="error",
                path="SKILL.md",
                message="Description exceeds TianShu's 1024 character limit.",
