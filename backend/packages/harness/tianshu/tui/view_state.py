"""Pure view-state reducer for the TianShu TUI.
...
The runtime bridge (``tianshu.tui.runtime``) is responsible for translating
``TianShuClient`` ``StreamEvent`` objects into these actions; the Textual app
