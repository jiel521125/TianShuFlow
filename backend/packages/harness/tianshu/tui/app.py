...
pure renderers. Agent runs execute on a worker *thread* (``TianShuClient.stream``
...
class TianShuTUI(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield ComposerInput(placeholder="Message TianShu…   ( / for commands )", id="composer")
