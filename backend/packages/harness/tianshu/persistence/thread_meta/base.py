...
Implementations:
- ThreadMetaRepository: SQL-backed (postgres via SQLAlchemy)
...
three-state semantics (see :mod:`tianshu.runtime.user_context`):
...
THREAD_PINNED_METADATA_KEY = "tianshu_pinned"
...
class ThreadMetaStore(abc.ABC):
    ...
    async def search(
        ...
        *,
        ...
        (``metadata.tianshu_pinned is True``), then by ``updated_at`` and
