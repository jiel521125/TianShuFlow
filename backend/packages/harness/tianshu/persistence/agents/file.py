...
:mod:`tianshu.config.agents_config` dispatch here without changing behaviour).
...
Path/user resolution is done through the :mod:`tianshu.config.agents_config`
...
from tianshu.config import agents_config as _ac
from tianshu.config.agents_config import (
    SOUL_FILENAME,
    AgentConfig,
    resolve_agent_dir,
    validate_agent_name,
