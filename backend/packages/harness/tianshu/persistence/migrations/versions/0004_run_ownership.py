...
def _dedupe_active_runs_per_thread() -> None:
    ...
    by an old gate, and anyone who ran ``GATEWAY_WORKERS>1``
...
def upgrade() -> None:
    from tianshu.persistence.migrations._helpers import safe_add_column
...
def downgrade() -> None:
    ...
    from tianshu.persistence.migrations._helpers import safe_drop_column
