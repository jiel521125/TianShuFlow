...
async def init_engine(
    ...
    *,
    ...
    Args:
        ...
        url: SQLAlchemy async URL (for postgres).
    ...
    # Concurrency: Postgres advisory lock (true cross-process).
    # See tianshu.persistence.bootstrap for the full state machine.
