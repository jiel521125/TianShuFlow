...
``langchain_openai.ChatOpenAI`` currently ignores that field, so TianShu's
...
which TianShu already understands.
"""
...
class PatchedChatMiniMax(ChatOpenAI):
    ...
    def _strip_user_message_names(payload: dict) -> None:
        ...
        TianShu middlewares tag user messages with internal provenance names
