...
set ``MemoryConfig.manager_class`` -- nothing else in tian-shu changes.
...
them directly from ``tianshu.agents.memory.backends.deermem.deermem.core.*``.
"""

from tianshu.agents.memory.manager import (
    MemoryConflictError,
