...
memory search results back to TianShu's backend-neutral shapes.
"""
...
# ABC contract -- the only TianShu import in this backend package.
...
_SESSION_NAMESPACE = "tianshu-openviking-v1"
...
class OpenVikingMemoryManager(MemoryManager):
    ...
    def _identity(self, user_id: str | None, agent_name: str | None) -> OpenVikingIdentity:
        ...
        # TianShu scope also prevents raw emails/usernames from leaving the
