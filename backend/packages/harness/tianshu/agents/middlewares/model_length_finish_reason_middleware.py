...
Background — see issue bytedance/tian-shu#4271.
...
content. TianShu should preserve that content for audit, but it should not
...
from tianshu.agents.middlewares.model_length_termination_detectors import (
