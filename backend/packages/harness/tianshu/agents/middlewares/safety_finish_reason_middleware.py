...
Background — see issues bytedance/tian-shu#3028 (truncated tool calls) and
...
from tianshu.agents.middlewares.safety_termination_detectors import (
    SafetyTermination,
    SafetyTerminationDetector,
    default_detectors,
)
from tianshu.agents.middlewares.tool_call_metadata import clone_ai_message_with_tool_calls
from tianshu.runtime.events.catalog import MIDDLEWARE_SAFETY_TERMINATION_TAG
