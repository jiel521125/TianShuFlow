...
from tianshu.config.subagents_config import (
...
from tianshu.skills.storage import get_or_new_skill_storage, get_or_new_user_skill_storage
from tianshu.skills.types import Skill, SkillCategory
from tianshu.subagents import get_available_subagent_names
from tianshu.tools.builtins.tool_search import get_deferred_tools_prompt_section
...
# ``_user_scoped_storages`` in ``tianshu.skills.storage``; the
...
def _start_enabled_skills_refresh_thread() -> None:
    threading.Thread(
        ...
        name="tianshu-enabled-skills-loader",
        daemon=True,
    ).start()
...
def _build_available_subagents_description(available_names: list[str], bash_available: bool, *, app_config: AppConfig | None = None) -> str:
    ...
    from tianshu.subagents.registry import get_subagent_config
...
is user-managed data (visible and editable via the TianShu UI) — you may
...
TianShu is an open-source AI agent framework that gained significant traction in early 2026
[citation:GitHub Repository](https://github.com/bytedance/tian-shu). The project focuses on
providing a production-ready agent system with sandbox execution and memory management
[citation:TianShu Documentation](https://tian-shu.dev/docs).
...
### Primary Sources
- [GitHub Repository](https://github.com/bytedance/tian-shu) - Official source code and documentation
- [TianShu Documentation](https://tian-shu.dev/docs) - Technical specifications
...
- ✅ RIGHT in Sources: `[GitHub Repository](https://github.com/bytedance/tian-shu) - 官方源代码和文档`
...
"""
        ...
        from tianshu.agents.memory import MemoryManagerError
...
def get_skills_prompt_section(
    ...
    *,
    ...
    if skill_names is not None:
        from tianshu.skills.describe import get_skill_index_prompt_section
...
def _build_acp_section(*, app_config: AppConfig | None = None) -> str:
    ...
    if app_config is None:
        try:
            from tianshu.config.acp_config import get_acp_agents
...
def apply_prompt_template(
    ...
    *,
    ...
    return SYSTEM_PROMPT_TEMPLATE.format(
        agent_name=agent_name or "TianShu 2.0",
