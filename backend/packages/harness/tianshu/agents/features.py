"""Declarative feature flags and middleware positioning for create_tianshu_agent.
...
class RuntimeFeatures:
    """Declarative feature flags for ``create_tianshu_agent``.
    ...
    # Explicit memory config for direct create_tianshu_agent(features=...) callers.
