...
When enabled, a pluggable :class:`~tianshu.authz.provider.AuthorizationProvider`
...
run-time execution deny (reuses :class:`~tianshu.guardrails.middleware.GuardrailMiddleware`
...
class AuthorizationProviderConfig(BaseModel):
    ...
    use: str = Field(description="Class path (e.g. 'tianshu.authz.rbac:RbacAuthorizationProvider')")
...
class AuthorizationConfig(BaseModel):
    ...
    Mirrors :class:`~tianshu.config.guardrails_config.GuardrailsConfig` in
