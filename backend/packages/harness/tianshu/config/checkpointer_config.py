...
class CheckpointerConfig(BaseModel):
    ...
    type: CheckpointerType = Field(
        ...
        "'postgres' persists to PostgreSQL (install with tianshu-harness[postgres])."
    )
    connection_string: str | None = Field(
        default=None,
        description="Connection string for postgres (DSN). "
...
def ensure_config_loaded() -> None:
    ...
    from tianshu.config.app_config import _app_config, get_app_config
