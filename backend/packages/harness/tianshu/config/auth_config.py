...
class OIDCProviderConfig(BaseModel):
    ...
    issuer: str = Field(description="OIDC issuer URL (e.g. https://keycloak.example.com/realms/tianshu)")
    ...
    auto_create_users: bool = Field(
        default=True,
        description="Automatically create a TianShu user on first SSO login",
    )
...
class AuthAppConfig(BaseModel):
    """Authentication configuration section for the TianShu app config."""
