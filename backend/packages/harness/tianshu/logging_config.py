"""Logging setup helpers for TianShu."""
...
_TRACE_FILTER_NAME = "tianshu_trace_context_filter"
...
def configure_logging(config: object) -> None:
    """Configure TianShu logging from an AppConfig-like object.
    ...
    for handler in logging.root.handlers:
        if enhanced:
            ...
            if getattr(handler.formatter, "_tianshu_trace_formatter", False):
