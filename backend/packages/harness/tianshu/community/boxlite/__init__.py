"""BoxLite micro-VM backend for TianShu sandboxes.
...
macOS) — behind TianShu's :class:`Sandbox` / :class:`SandboxProvider` contract.
Each sandbox is a hardware-isolated VM with its own kernel that runs any OCI
image unchanged. See https://github.com/bytedance/tian-shu/issues/3936.
...
virtualization when TianShu itself runs inside a cloud VM); macOS uses
