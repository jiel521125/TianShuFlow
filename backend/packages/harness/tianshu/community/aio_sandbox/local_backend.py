...
from tianshu.utils.network import get_free_port, release_port
...
def _resolve_docker_bind_host(sandbox_host: str | None = None, bind_host: str | None = None) -> str:
    ...
    narrower bind with ``TIAN_SHU_SANDBOX_BIND_HOST``.  When operators choose
    ...
    """
    explicit_bind = bind_host if bind_host is not None else os.environ.get("TIAN_SHU_SANDBOX_BIND_HOST")
    ...
    host = sandbox_host if sandbox_host is not None else os.environ.get("TIAN_SHU_SANDBOX_HOST", "localhost")
...
class LocalContainerBackend(SandboxBackend):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            container_prefix: Prefix for container names (e.g., "tian-shu-sandbox").
    ...
    def create(
        ...
        *,
        ...
        sandbox_host = os.environ.get("TIAN_SHU_SANDBOX_HOST", "localhost")
        return SandboxInfo(
