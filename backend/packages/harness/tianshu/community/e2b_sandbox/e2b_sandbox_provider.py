"""``E2BSandboxProvider`` — TianShu :class:`SandboxProvider` for e2b cloud.
...
from tianshu.sandbox.sandbox_provider import SandboxProvider
...
META_KEY_USER = "tian_shu_user"
META_KEY_THREAD = "tian_shu_thread"
META_KEY_PROVIDER = "tian_shu_provider"
META_KEY_GATEWAY = "tian_shu_gateway"
META_KEY_CREATED_AT = "tian_shu_created_at"
META_KEY_CAPACITY_LEDGER = "tian_shu_capacity_ledger"
META_KEY_CAPACITY_RESERVATION = "tian_shu_capacity_reservation"
...
class E2BSandboxProvider(SandboxProvider):
    ...
    def __init__(self) -> None:
        ...
        # Active sandboxes, keyed by TianShu-side sandbox id (== e2b id).
    ...
    def _create_sandbox(self, thread_id: str | None, *, user_id: str) -> str:
        ...
        # Materialise TianShu's virtual path layout (/mnt/user-data/...) inside
    ...
    def _bootstrap_sandbox_paths(self, client: E2BClientSandbox) -> None:
        """Materialise TianShu's virtual path layout inside the e2b VM.
    ...
    def _skill_projection_mounts(self, user_id: str) -> list[tuple[Path, str, bool]]:
        ...
        """
        from tianshu.skills.projection import ensure_skill_projections
    ...
    def _sync_outputs_to_host(
        ...
        *,
        ...
        TianShu's ``/api/threads/{tid}/artifacts/...`` endpoint resolves
        ...
        """
        from tianshu.config.paths import get_paths  # lazy import to avoid cycles
