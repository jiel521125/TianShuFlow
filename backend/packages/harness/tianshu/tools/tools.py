...
from tianshu.tools.builtins import ask_clarification_tool, list_uploaded_files, present_file_tool, review_skill_package, task_tool, view_image_tool
...
def _is_host_bash_tool(tool: object) -> bool:
    ...
    if group == "bash":
        return True
    if use == "tianshu.sandbox.tools:bash_tool":
        return True
    return False
...
def get_available_tools(
    ...
    *,
    ...
    `initialize_mcp_tools()` from tianshu.mcp module.
    ...
    if getattr(skill_evolution_config, "enabled", False):
        from tianshu.tools.skill_manage_tool import skill_manage_tool
    ...
    if include_mcp:
        try:
            ...
            from tianshu.mcp.cache import get_cached_mcp_tools
    ...
    try:
        from tianshu.tools.builtins.invoke_acp_agent_tool import build_invoke_acp_agent_tool
