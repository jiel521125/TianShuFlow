...
from tianshu.config.agents_config import load_agent_config, preserve_non_managed_fields, validate_agent_name
from tianshu.config.app_config import get_app_config
from tianshu.config.paths import get_paths
from tianshu.persistence.agents import get_agent_store
...
# ``tianshu.agents.lead_agent.agent``); this set is the in-tool mirror
...
def update_agent(
    ...
    # ``tianshu.agents.lead_agent.agent``). The same channel set is
