...
from tianshu.sandbox.security import LOCAL_BASH_SUBAGENT_DISABLED_MESSAGE, is_host_bash_allowed
from tianshu.subagents import SubagentExecutor, get_available_subagent_names, get_subagent_config
from tianshu.subagents.config import resolve_subagent_model_name
...
from tianshu.trace_context import TIANSHU_TRACE_METADATA_KEY, get_current_trace_id, normalize_trace_id
from tianshu.utils.custom_events import aemit_custom_event
...
async def task_tool(
    ...
    tianshu_trace_id = normalize_trace_id(parent_context.get(TIANSHU_TRACE_METADATA_KEY)) or normalize_trace_id(metadata.get(TIANSHU_TRACE_METADATA_KEY)) or get_current_trace_id()
