"""End-to-end demo: SafetyFinishReasonMiddleware on the real TianShu lead-agent.

What it proves
--------------
- The real ``make_lead_agent`` / ``TianShuClient`` pipeline is built (full
...
def main() -> int:
    ...
    # at import time via ``from tianshu.models import create_chat_model``,
    ...
    # imported names.
    import tianshu.agents.lead_agent.agent as lead_agent_module
    import tianshu.client as client_module
