...
Requirements:
    ...
    resolves tianshu-harness and app packages correctly:
...
async def main():
    ...
    from tianshu.config.app_config import apply_logging_level

    app_config = get_app_config()
    apply_logging_level(app_config.log_level)

    # Delay the rest of the tianshu imports until *after* logging is installed
    # so that any import-time side effects (e.g. tianshu.agents starts a
    ...
    from tianshu.mcp import initialize_mcp_tools
