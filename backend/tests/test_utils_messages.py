"""Tests for tianshu.utils.messages text extraction.
...
from tianshu.utils.messages import ORIGINAL_USER_CONTENT_KEY, message_content_to_text, message_to_text, restore_original_human_message
