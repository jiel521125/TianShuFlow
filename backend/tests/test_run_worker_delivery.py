...
from tianshu.runtime.runs.worker import RunContext, _delivery_content_with_outputs, run_agent
...
async def test_changed_outputs_succeed_when_a_produced_output_is_presented(monkeypatch):
    ...
    store = MemoryRunEventStore()
    monkeypatch.setattr(
        "tianshu.runtime.runs.worker._produced_output_paths",
...
async def test_delivery_event_is_singleton_across_goal_continuations(monkeypatch):
    ...
    monkeypatch.setattr("tianshu.runtime.runs.worker._prepare_goal_continuation_input", prepare_continuation)
...
async def test_delivery_event_emitted_when_checkpoint_preflight_fails(monkeypatch):
    ...
    monkeypatch.setattr("tianshu.runtime.runs.worker.aensure_checkpoint_mode_compatible", compatibility_check)
