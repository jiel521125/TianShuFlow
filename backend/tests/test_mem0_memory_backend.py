...
from tianshu.agents.memory.backends.mem0.client import Mem0APIError, Mem0AuthError, Mem0Client
from tianshu.agents.memory.backends.mem0.config import Mem0Config
...
from tianshu.agents.memory.backends.mem0.message_filtering import (  # noqa: E402
...
from tianshu.agents.memory.backends.mem0.mem0_manager import Mem0Manager  # noqa: E402
...
class TestMem0ManagerConstruction:
    def test_from_config_fail_fast_pings(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        fake = FakeMem0Client()
        monkeypatch.setattr(
            "tianshu.agents.memory.backends.mem0.mem0_manager.Mem0Client",
            lambda **kwargs: fake,
        )
...
class TestMem0ManagerAdd:
    ...
    def test_add_write_error_raise_policy(self) -> None:
        from tianshu.agents.memory.manager import MemoryManagerError
...
class TestMem0Discovery:
    def test_scan_backends_registers_mem0(self) -> None:
        import tianshu.agents.memory.manager as manager_module
    ...
    def test_factory_resolves_mem0(self, monkeypatch: pytest.MonkeyPatch) -> None:
        from tianshu.agents.memory.manager import get_memory_manager, reset_memory_manager
