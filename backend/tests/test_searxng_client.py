...
from tianshu.community.searxng import tools
from tianshu.community.searxng.searxng_client import SearxngClient
...
class TestSearxngClient:
    ...
    async def test_search_success(self):
        ...
        with patch("tianshu.community.searxng.searxng_client.httpx.AsyncClient") as mock_cls:
            mock_ctx = MagicMock()
...
class TestSearxngTools:
    ...
    @patch("tianshu.community.searxng.tools._get_searxng_client")
    async def test_web_search_tool_success(self, mock_get_client):
        ...
        with patch("tianshu.community.searxng.tools._get_tool_config", return_value=None):
    ...
    async def test_web_search_tool_with_max_results(self, mock_get_client):
        ...
        with patch("tianshu.community.searxng.tools._get_tool_config", return_value={"max_results": "3"}):
