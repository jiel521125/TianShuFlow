...
from tianshu.community.ddg_search import tools
...
def test_web_search_tool_reads_ddgs_options_from_config() -> None:
    with patch("tianshu.community.ddg_search.tools.get_app_config") as mock_config:
        ...
        with patch("tianshu.community.ddg_search.tools._search_text") as mock_search:
