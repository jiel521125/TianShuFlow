...
Bytedance/tian-shu issue #3144: the hot-reload boundary is the contract
...
``tianshu.config.reload_boundary`` is the machine-readable source of truth;
...
from tianshu.config.reload_boundary import (
    STARTUP_ONLY_FIELDS,
    STARTUP_ONLY_PREFIX,
