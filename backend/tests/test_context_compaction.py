...
from tianshu.agents.middlewares.summarization_middleware import SummaryGenerationError
from tianshu.runtime import context_compaction
from tianshu.runtime.checkpoint_state import CheckpointStateAccessor
from tianshu.runtime.context_compaction import ContextCompactionFailed, compact_thread_context
...
async def test_compact_thread_context_reads_materialized_state_and_overwrites_messages(monkeypatch):
    ...
    import tianshu.config.agents_config as agents_config
