...
TianShu tools annotate their runtime parameter as ``Runtime``
(``tianshu.tools.types.Runtime`` = ``ToolRuntime[dict[str, Any], ThreadState]``)
...
tool call because the actual context TianShu installs is a dict. Using the
...
from tianshu.tools.builtins.list_uploaded_files_tool import list_uploaded_files
from tianshu.tools.builtins.present_file_tool import present_file_tool
from tianshu.tools.builtins.setup_agent_tool import setup_agent
from tianshu.tools.builtins.task_tool import task_tool
from tianshu.tools.builtins.update_agent_tool import update_agent
from tianshu.tools.builtins.view_image_tool import view_image_tool
