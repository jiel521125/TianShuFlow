...
from tianshu.config.paths import VIRTUAL_PATH_PREFIX, Paths
from tianshu.mcp import tools as mcp_tools
...
def _patch_paths(paths: Paths):
    return patch("tianshu.mcp.tools.get_paths", return_value=paths)
