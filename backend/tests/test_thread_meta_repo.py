...
from tianshu.persistence.thread_meta import THREAD_PINNED_METADATA_KEY, InvalidMetadataFilterError, ThreadMetaRepository
...
class TestThreadMetaRepository:
    ...
    async def test_search_metadata_all_unsafe_keys_raises(self, repo, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="tianshu.persistence.thread_meta.sql"):
...
class TestJsonMatchCompilation:
    """Verify compiled SQL for the PostgreSQL dialect."""
