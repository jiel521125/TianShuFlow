...
from tianshu.runtime.runs.worker import RunContext, _checkpoint_thread_lock, _linearize_delta_checkpoint_resume, run_agent
...
async def test_regenerating_in_a_branched_thread_does_not_resurrect_the_old_answer():
...
async def test_run_agent_streams_from_the_linearized_delta_resume():
...
async def test_run_agent_serializes_resume_preparation_with_checkpoint_writes(monkeypatch):
    ...
    monkeypatch.setattr("tianshu.runtime.runs.worker._capture_rollback_point", capture_rollback_point)
    monkeypatch.setattr("tianshu.runtime.runs.worker._linearize_delta_checkpoint_resume", linearize_resume)
...
async def test_cancelled_delta_resume_rolls_back_to_pre_linearization_head():
