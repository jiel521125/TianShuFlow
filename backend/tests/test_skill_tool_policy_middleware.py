...
@pytest.mark.parametrize(
    ...
    [
        "tianshu.agents.middlewares.skill_activation_middleware.SkillActivationMiddleware",
        "tianshu.agents.middlewares.skill_tool_policy_middleware.SkillToolPolicyMiddleware",
    ],
)
...
def test_slash_activation_and_policy_compose_on_the_same_model_call(monkeypatch):
    from tianshu.agents.middlewares.skill_activation_middleware import SkillActivationMiddleware, _Activation, _ActivationResolution
