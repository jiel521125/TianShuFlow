...
TianShu neutralizes framework/injection tags in the genuine user message. These
...
from tianshu.agents.middlewares.input_sanitization_middleware import _check_user_content
from tianshu.agents.middlewares.tool_result_sanitization_middleware import (
    ToolResultSanitizationMiddleware,
    _neutralize_content,
)
from tianshu.community.browserless.browserless_client import BrowserlessScreenshotResult
from tianshu.community.browserless.tools import _target_status_warning
