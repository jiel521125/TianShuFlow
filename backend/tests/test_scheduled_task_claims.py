...
@pytest.mark.asyncio
async def test_claim_due_tasks_claims_only_due_rows(pg_test_engine):
...
@pytest.mark.asyncio
async def test_claim_reclaims_task_stuck_in_running_with_expired_lease(pg_test_engine):
...
@pytest.mark.asyncio
async def test_claim_skips_task_with_active_lease(pg_test_engine):
