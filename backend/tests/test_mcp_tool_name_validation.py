...
def _load(server_tools: list[StructuredTool]) -> tuple[list, MagicMock]:
    ...
    with (
        ...
        patch("tianshu.config.extensions_config.ExtensionsConfig.from_file", return_value=ext),
        patch("tianshu.mcp.tools.build_servers_config", return_value={"srv": {"transport": "sse"}}),
