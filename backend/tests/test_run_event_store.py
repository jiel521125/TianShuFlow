...
class TestDbRunEventStore:
    """Tests for DbRunEventStore with the live-PostgreSQL test engine."""
    ...
    @pytest.mark.anyio
    async def test_basic_crud(self, pg_test_engine):
    ...
    @pytest.mark.anyio
    async def test_put_if_absent_is_idempotent(self, pg_test_engine):
        from tianshu.persistence.engine import get_session_factory
        from tianshu.runtime.events.store.db import DbRunEventStore
    ...
    @pytest.mark.anyio
    async def test_trace_content_truncation(self, pg_test_engine):
        from tianshu.persistence.engine import get_session_factory
        from tianshu.runtime.events.store.db import DbRunEventStore
    ...
    @pytest.mark.anyio
    async def test_structured_content_round_trips(self, pg_test_engine):
        from tianshu.persistence.engine import get_session_factory
        from tianshu.runtime.events.store.db import DbRunEventStore
    ...
    @pytest.mark.anyio
    async def test_pagination(self, pg_test_engine):
        from tianshu.persistence.engine import get_session_factory
        from tianshu.runtime.events.store.db import DbRunEventStore
    ...
    @pytest.mark.anyio
    async def test_put_batch_seq_continuity(self, pg_test_engine):
    ...
    @pytest.mark.anyio
    async def test_put_batch_accepts_structured_content(self, pg_test_engine):
        from tianshu.persistence.engine import get_session_factory
        from tianshu.runtime.events.store.db import DbRunEventStore
    ...
    @pytest.mark.anyio
    async def test_dict_content_keeps_legacy_metadata_flag(self, pg_test_engine):
        from tianshu.persistence.engine import get_session_factory
        from tianshu.runtime.events.store.db import DbRunEventStore
...
class TestDbRunEventStoreWriteLock:
    """Per-thread seq-assignment lock (serializes seq assignment per thread).
    ...
    @pytest.mark.anyio
    async def test_concurrent_put_batch_same_thread_has_no_seq_collision(self, pg_test_engine):
        import asyncio
    ...
    @pytest.mark.anyio
    async def test_delete_by_thread_evicts_orphaned_write_lock(self, pg_test_engine):
        from tianshu.persistence.engine import get_session_factory
        from tianshu.runtime.events.store.db import DbRunEventStore
    ...
    @pytest.mark.anyio
    async def test_delete_by_thread_keeps_lock_held_by_inflight_writer(self, pg_test_engine):
        from tianshu.persistence.engine import get_session_factory
        from tianshu.runtime.events.store.db import DbRunEventStore
...
class TestMakeRunEventStore:
    ...
    @pytest.mark.anyio
    async def test_db_backend_with_engine(self, pg_test_engine):
        from unittest.mock import MagicMock
    ...
    async def test_db_backend_no_engine_falls_back(self):
        ...
        from tianshu.persistence.engine import close_engine, init_engine
        from tianshu.runtime.events.store import make_run_event_store
...
class TestJsonlRunEventStore:
    ...
    async def test_rejects_noncanonical_thread_ids(self, tmp_path, thread_id):
        from tianshu.runtime.events.store.jsonl import JsonlRunEventStore
    ...
    @pytest.mark.anyio
    async def test_file_at_correct_path(self, pg_test_engine):
        from tianshu.runtime.events.store.jsonl import JsonlRunEventStore
    ...
    @pytest.mark.anyio
    async def test_cross_run_messages(self, pg_test_engine):
        from tianshu.runtime.events.store.jsonl import JsonlRunEventStore
