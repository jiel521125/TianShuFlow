...
from tianshu.config.app_config import apply_logging_level, logging_level_from_config
...
class TestApplyLoggingLevel:
    """Tests for ``apply_logging_level`` — verifies tianshu/app logger and handler levels."""
    ...
    def setup_method(self) -> None:
        ...
        self._original_tianshu_level = logging.getLogger("tianshu").level
    ...
    def teardown_method(self) -> None:
        ...
        logging.getLogger("tianshu").setLevel(self._original_tianshu_level)
        logging.getLogger("app").setLevel(self._original_app_level)

    def test_sets_tianshu_app_logger_levels(self) -> None:
        apply_logging_level("debug")
        assert logging.getLogger("tianshu").level == logging.DEBUG
    ...
    def test_defaults_to_info(self) -> None:
        ...
        assert logging.getLogger("tianshu").level == logging.INFO
