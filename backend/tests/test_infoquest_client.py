...
from tianshu.community.infoquest import tools
from tianshu.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("tianshu.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("tianshu.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("tianshu.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/bytedance/python/tian-shuv2/tian-shu/backend/tests/test_infoquest_client.py
