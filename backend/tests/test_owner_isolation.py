...
async def test_thread_meta_cross_user_isolation(pg_test_engine):
...
@pytest.mark.anyio
@pytest.mark.no_auto_user
async def test_thread_meta_cross_user_mutation_denied(pg_test_engine):
...
@pytest.mark.anyio
@pytest.mark.no_auto_user
async def test_runs_cross_user_isolation(pg_test_engine):
    from tianshu.persistence.engine import get_session_factory
...
@pytest.mark.anyio
@pytest.mark.no_auto_user
async def test_runs_cross_user_delete_denied(pg_test_engine):
    from tianshu.persistence.engine import get_session_factory
    from tianshu.persistence.run import RunRepository
...
@pytest.mark.anyio
@pytest.mark.no_auto_user
async def test_run_events_cross_user_isolation(pg_test_engine):
...
@pytest.mark.anyio
@pytest.mark.no_auto_user
async def test_run_events_cross_user_delete_denied(pg_test_engine):
...
@pytest.mark.anyio
@pytest.mark.no_auto_user
async def test_feedback_cross_user_isolation(pg_test_engine):
    from tianshu.persistence.engine import get_session_factory
...
@pytest.mark.anyio
@pytest.mark.no_auto_user
async def test_feedback_cross_user_delete_denied(pg_test_engine):
    from tianshu.persistence.engine import get_session_factory
    from tianshu.persistence.feedback import FeedbackRepository
...
@pytest.mark.anyio
@pytest.mark.no_auto_user
async def test_repository_without_context_raises(pg_test_engine):
...
@pytest.mark.anyio
@pytest.mark.no_auto_user
async def test_explicit_none_bypasses_filter(pg_test_engine):
