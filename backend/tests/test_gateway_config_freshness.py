...
Bytedance/tian-shu issue #3107 BUG-001: the worker and lead-agent path
...
def test_get_config_reflects_file_mtime_reload(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("TIAN_SHU_CONFIG_PATH", str(config_file))
...
def test_get_config_returns_503_on_any_load_failure(monkeypatch, exception):
    ...
    Bytedance/tian-shu issue #3107 BUG-001 review: the original snapshot
