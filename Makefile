# TianShu - Unified Development Environment
...
help:
	@echo "TianShu Development Commands:"
...
detect-thread-boundaries:
	@$(BACKEND_UV_RUN) python ../scripts/detect_thread_boundaries.py --json-output ../.tian-shu/thread-boundary-inventory.json
...
clean: stop
	@echo "Cleaning up..."
	@-rm -rf backend/.tian-shu 2>/dev/null || true
