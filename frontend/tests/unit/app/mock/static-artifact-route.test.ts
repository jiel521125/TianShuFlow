...
describe("static artifact mock route", () => {
  ...
  it("streams only a manifest-owned public artifact", async () => {
    ...
    const request = new NextRequest(
      "http://tian-shu.test/mock/api/threads/thread/artifacts/file",
    );
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "http://tian-shu.test/demo/threads/7cfa5f8f-a2f8-47ad-acbd-da7137baf990/user-data/outputs/index.html",
