 ...
 * + TIANSHU_RECORD_OUT in the environment — never run in CI.
 *
  ...
  webServer: [
    {
      ...
      env: {
        ...
        ...(process.env.TIANSHU_RECORD_OUT
          ? { TIANSHU_RECORD_OUT: process.env.TIANSHU_RECORD_OUT }
          : {}),
    ...
    },
    {
      ...
      env: {
        ...
        TIAN_SHU_AUTH_DISABLED: "1",
        BETTER_AUTH_SECRET: "local-dev-secret",
        TIAN_SHU_INTERNAL_GATEWAY_BASE_URL: "http://127.0.0.1:8012",
      },
    },
  ],
});
