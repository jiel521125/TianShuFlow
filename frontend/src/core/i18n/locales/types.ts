...
export interface Translations {
  ...
  // Thread ↔ workspace folder binding (conversation archival + document loading)
  threadWorkspace: {
    bind: string;
    unbind: string;
    boundTo: (workspaceName: string, folderName: string) => string;
    ...
    loadFailed: string;
    noBindingHint: string;
    remove: string;
    documentContextHint: string;
    emptyDocuments: string;
    load: string;
    selectWorkspaceFolder: string;
    backToWorkspaces: string;
    boundOnCreate: string;
  ...
  gitToolbar: {
    trigger: string;
    triggerBound: (folderName: string) => string;
    selectAction: string;
    boundFolder: (folderName: string) => string;
    pull: string;
    pullDescription: string;
    push: string;
    pushDescription: string;
    pushWithoutBinding: string;
    choosePullFolder: string;
    choosePushFolder: string;
    pullingFolder: (folderName: string) => string;
    pushingFolder: (folderName: string) => string;
  };
  ...
  settings: {
    ...
    tools: {
      ...
      form: {
        ...
        toolNamePrefixHint: string;
        toolCallTimeout: string;
        toolCallTimeoutPlaceholder: string;
      };
    };
    mcpTools: {
      title: string;
      followingGlobal: string;
    };
    channels: {
      title: string;
      description: string;
