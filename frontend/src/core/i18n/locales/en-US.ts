...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 TianShu, an open source super agent. With built-in and custom skills, TianShu helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of TianShu. With customized skills,\nTianShu can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  // Per-user workspace (personal space)
  userWorkspace: {
    title: "Workspace",
    emptyTitle: "Create your first workspace",
    emptyDescription:
      "Your workspace keeps documents organized per project. Create a workspace, add project folders, then write Markdown documents inside them.",
    ...
    documents: "Documents",
    emptyProjects:
      "No project folders yet. Create one to start organizing documents.",
    ...
    documentNamePlaceholder: "e.g. README.md",
    descriptionLabel: "Description",
    descriptionPlaceholder: "Optional description…",
    defaultBadge: "Default",
    fileCount: (count) => `${count} file${count === 1 ? "" : "s"}`,
    deleteWorkspaceConfirm:
      "Delete this workspace? All its folders and documents will be permanently removed.",
    deleteFolderConfirm:
      "Delete this project folder? All documents inside it will be permanently removed.",
    deleteFileConfirm: "Delete this document? This cannot be undone.",
    loadFailed: "Failed to load workspaces.",
    createFailed: "Failed to create.",
    updateFailed: "Failed to update.",
    deleteFailed: "Failed to delete.",
    loadFileFailed: "Failed to load the document.",
  ...
  threadWorkspace: {
    bind: "Bind folder",
    unbind: "Unbind",
    boundTo: (workspaceName, folderName) => `${workspaceName} / ${folderName}`,
    selectWorkspace: "Select workspace",
    selectFolder: "Select project folder",
    noWorkspaces: "No workspaces yet",
    noFolders: "No folders in this workspace yet",
    createWorkspace: "Create a workspace",
    unbindConfirm:
      "Unbind this conversation from the workspace folder? It will no longer be associated with any folder.",
    loadDocuments: "Load documents",
    loadedCount: (count) =>
      `Loaded ${count} document${count === 1 ? "" : "s"} into conversation context`,
    loadFailed: "Failed to load workspace documents.",
    noBindingHint: "Bind a workspace folder first to load its documents.",
    remove: "Remove",
    documentContextHint: "sent as context with your next message",
    emptyDocuments: "No documents in this folder",
    load: "Load",
    selectWorkspaceFolder: "Workspace folder",
    backToWorkspaces: "Back to workspaces",
    boundOnCreate:
      "Folder selected. It will be bound after you send your first message.",
    archivedCount: (count) =>
      `Archived ${count} document${count === 1 ? "" : "s"} into the bound folder`,
  },

  // Git toolbar (pull / push) in the conversation composer
  gitToolbar: {
    trigger: "Git pull / push",
    triggerBound: (folderName) => `Git · ${folderName}`,
    selectAction: "Choose a git action",
    boundFolder: (folderName) => `Bound folder: ${folderName}`,
    pull: "Pull",
    pullDescription: "Sync the remote repository into the current folder",
    push: "Push",
    pushDescription: "Push all files of the current folder to the remote",
    pushWithoutBinding:
      "Bind or pull a folder first before pushing",
    choosePullFolder: "Choose a workspace folder to pull into",
    choosePushFolder: "Choose a workspace folder to push",
    pullingFolder: (folderName) => `Pulling into "${folderName}"`,
    pushingFolder: (folderName) => `Pushing "${folderName}"`,
  },

  // Input Box
  inputBox: {
    placeholder: "How can I assist you today?",
    disclaimer: "Tianshu is AI and can make mistakes",
    createSkillPrompt:
    ...
    voiceInputStart:
      "Dictate with voice. TianShu receives only transcribed text; audio is handled by your browser or system speech service.",
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. TianShu is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but TianShu could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "TianShu's official website",
    githubTooltip: "TianShu on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "TianShu on GitHub",
  ...
  channels: {
    ...
    descriptions: {
      telegram: "Telegram direct messages through your TianShu bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your TianShu bot.",
      feishu: "Feishu and Lark messages through your TianShu app.",
      dingtalk: "DingTalk Stream Push messages through your TianShu bot.",
      wechat: "WeChat iLink messages through your TianShu bot.",
      wecom: "WeCom messages through your TianShu AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to TianShu",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate TianShu faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how TianShu looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "TianShu automatically learns from your conversations in the background. These memories help TianShu understand you better and deliver a more personalized experience.",
    ...
    tools: {
      title: "Tools",
      description:
        "Manage MCP servers you registered yourself; their tools become available in conversations once added.",
      ...
      form: {
        ...
        nameDuplicate: "A server with this name already exists",
        displayName: "Display name",
        displayNamePlaceholder: "e.g. My GitHub server",
        type: "Transport type",
        ...
        commandHint:
          "Only allowlisted commands can be run (npx, uvx; extendable via backend environment variable).",
        ...
        envInvalid:
          "Invalid environment variable format; use KEY=VALUE per line",
        envSetHint: "Secret values are stored; leave blank to keep them.",
        clearEnv: "Clear saved secret values",
        url: "Server URL",
        urlPlaceholder: "e.g. https://example.com/mcp",
        urlRequired: "sse/http transport requires a server URL",
        description: "Description",
        descriptionPlaceholder: "Describe the tools this server provides",
        toolNamePrefix: "Prefix tool names with the server name",
        toolNamePrefixHint:
          "When on, tools are named like serverName_toolName to avoid collisions with tools from other servers.",
        toolCallTimeout: "Tool call timeout (seconds)",
        toolCallTimeoutPlaceholder: "e.g. 60",
      },
    },
    mcpTools: {
      title: "MCP Tools",
      followingGlobal:
        "All MCP servers you registered are currently enabled. Toggle the switch above to personalize.",
    },
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to TianShu from outside the browser.",
      disabled:
    ...
    models: {
      title: "Models",
      description:
        "Add your own LLM providers and models. Saved models appear in the chat model selector immediately.",
      empty:
        "No models yet. Add your first model to chat with your own provider.",
      addModel: "Add model",
      editModel: "Edit model",
      deleteModel: "Delete",
      deleteConfirmTitle: "Delete this model?",
      deleteConfirmDescription: (name: string) =>
        `“${name}” will be removed from your models immediately. This action cannot be undone.`,
      name: "Name",
      namePlaceholder: "e.g. my-gpt-4",
      nameHint:
        "Unique handle used in the model selector. Letters, digits, dots, dashes and underscores, starting with a letter or digit (max 128 chars).",
      displayName: "Display name",
      displayNamePlaceholder: "e.g. My GPT-4",
      provider: "Provider",
      modelId: "Model ID",
      modelIdPlaceholder: "e.g. gpt-4o",
      apiKey: "API key",
      apiKeyPlaceholder: "sk-...",
      apiKeySetHint: "A key is already stored. Leave blank to keep it.",
      baseUrl: "Base URL",
      ...
      invalidName:
        "Invalid name. Use letters, digits, dots, dashes or underscores, starting with a letter or digit.",
    ...
    integrations: {
      ...
      lark: {
        ...
        authStarted:
          "Authorization page opened. TianShu will detect completion automatically.",
        authorizationStillPending:
          'Authorization is not complete yet. Finish it in the browser; TianShu keeps checking automatically. You can click "I completed authorization" if the page does not update.',
        permissionTitle: "Authorization scope",
        permissionDescription:
          "By default, TianShu only completes the base sign-in and does not request any business permissions. Select the domains you need here; connected users can re-authorize to add more (scopes accumulate).",
        authDomains: {
          calendar: {
            label: "Calendar",
            description:
        ...
        openAuthLinkDescription:
          "Open the link below to authorize. TianShu keeps checking automatically and will save the connection after approval.",
        waitingAuthTitle: "Waiting for Lark authorization",
        waitingAuthDescription:
          "Finish authorization in the browser page that just opened. TianShu will update this panel automatically; the button below is only a fallback.",
        ...
        authNextDescription:
          "Click “Connect Lark”; TianShu checks the current status first and opens browser authorization only when disconnected or expired.",
      },
    },
    git: {
      title: "Git Integration",
      description:
        "Configure personal access tokens (PAT) for GitHub and Gitee to pull and push repositories from workspace chats.",
      save: "Save",
      saveSuccess: "Git configuration saved",
      noChanges: "Nothing to save",
      securityNote: "Tokens are stored securely and never returned to the browser.",
      configured: "Configured",
      notConfigured: "Not configured",
      tokenLabel: "Personal access token (PAT)",
      helpLabel: "How do I get a token?",
      github: {
        title: "GitHub",
        description: "For pulling / pushing GitHub repositories (https://github.com/...).",
        placeholder: "ghp_xxxxxxxxxxxxxxxxxxxx",
        help: [
          "Open GitHub → click your avatar → Settings → Developer settings (bottom of the left sidebar) → Personal access tokens → Tokens (classic).",
          "Click Generate new token (classic). Under Select scopes, check repo (full control of private repositories) — needed for both pull and push.",
          "Set an expiration date, then click Generate token at the bottom of the page.",
          "Copy the token that starts with ghp_ — it is only shown this one time.",
          "Paste it into the field above and click Save. Tokens are stored encrypted and never displayed again.",
        ],
      },
      gitee: {
        title: "Gitee",
        description: "For pulling / pushing Gitee repositories (https://gitee.com/...).",
        placeholder: "gitee_xxxxxxxxxxxxxxxxxxxx",
        help: [
          "Open Gitee → click your avatar → Settings → Security settings → Private token.",
          "Click Generate new token. Under the permission scopes, check projects (read/write access to repositories) — needed for both pull and push.",
          "Set an expiration date and click Submit.",
          "Copy the generated token that starts with gitee_ — it is only shown this one time.",
          "Paste it into the field above and click Save. Tokens are stored encrypted and never displayed again.",
        ],
      },
    },
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of TianShu.",
    ...
    notification: {
      title: "Notification",
      description:
        "TianShu only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
    ...
    userPrefs: {
      ...
      description:
        "These settings only apply to your account and do not affect other users.",
      inheritGlobal: "Inherit global configuration",
      inheritGlobalHint:
        "When off, only the items enabled below are active for you.",
      reset: "Reset to defaults",
      resetSuccess: "Reset to defaults",
      saveFailed: "Failed to save",
      resetFailed: "Failed to reset",
      loadFailed: "Failed to load your settings",
    },
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so TianShu cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    rememberMeDescription:
      "Keep this browser session when possible. TianShu stores only your email, never your password.",
    ...
    adminSetupRequiredDescription:
      "TianShu needs an administrator account before new regular accounts can be created.",
  ...
  workflow: {
    ...
    noWorkflowsDescription:
      "Create your first Agent workflow to enable multi-agent collaboration.",
