...
const GitSettingsPage = dynamic(
  () =>
    import("./git-settings-page").then((module) => module.GitSettingsPage),
  { loading: SettingsPageLoading },
);
...
const WorkspaceSettingsPage = dynamic(
  () =>
    import("./workspace-settings-page").then(
      (module) => module.WorkspaceSettingsPage,
    ),
  { loading: SettingsPageLoading },
);
        ...
        <div className="grid min-h-0 flex-1 gap-4 md:grid-cols-[220px_minmax(0,1fr)]">
          ...
          <ScrollArea className="h-full min-h-0 rounded-lg border">
            <div className="space-y-8 p-6">
              ...
              {activeSection === "git" && <GitSettingsPage />}
              {activeSection === "integrations" && <IntegrationsSettingsPage />}
              {activeSection === "workspace" && <WorkspaceSettingsPage />}
