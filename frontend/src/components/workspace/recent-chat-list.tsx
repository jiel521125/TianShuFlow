...
export function RecentChatList() {
  ...
  const handleShare = useCallback(
    async (thread: AgentThread) => {
      ...
      const VERCEL_URL = "https://tian-shu-v2.vercel.app";
      const isLocalhost =
            ...
            >
              <VirtualThreadList
                ...
                renderItem={(thread) => {
                  ...
                  const folderBinding = workspaceFolderBindingOfThread(thread);
                  return (
                    <SidebarMenuItem
                    ...
                    >
                      <SidebarMenuButton isActive={isActive} asChild>
                        ...
                        >
                          ...
                          {folderBinding && (
                            <span
                              className="bg-muted text-muted-foreground ml-auto inline-flex h-5 max-w-16 shrink-0 items-center gap-1 rounded-md px-1.5 text-[10px] font-medium"
                              title={t.threadWorkspace.boundTo(
                                folderBinding.workspaceName,
                                folderBinding.folderName,
                              )}
                            >
