...
description: This tutorial walks you through your first complete agent conversation in TianShu — from launching the app to getting meaningful work done with the agent.
---
...
This tutorial walks you through your first complete agent conversation in TianShu — from launching the app to getting meaningful work done with the agent.

## Prerequisites

- TianShu app is running (see [Quick Start](/docs/application/quick-start))
...
The agent used the TianShu Harness to:
