---
title: TianShu App
description: TianShu App is the reference implementation of what a production TianShu experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  TianShu App is a complete Super Agent application built on top of TianShu
...
TianShu App is the reference implementation of what a production TianShu experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The TianShu App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, TianShu Harness                               |
| Reverse proxy     | nginx                                                                |
