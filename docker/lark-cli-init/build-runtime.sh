#!/bin/sh
# Stage the TianShu sandbox lark-cli runtime layout from official release
...
#   <dest>/.tianshu-lark-cli-runtime.json   {"version": "vX.Y.Z"}
#
...
# backend/packages/harness/tianshu/integrations/lark_cli.py
...
printf '{\n  "version": "%s"\n}\n' "$TAG" > "${DEST}/.tianshu-lark-cli-runtime.json"
