...
### 2. `backend/packages/harness/tianshu/agents/lead_agent/prompt.py`
...
### 4. `backend/packages/harness/tianshu/subagents/builtins/general_purpose.py`
...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_tianshu_20260201.md`

```diff
@@ -1,12 +1,3 @@
-<citations>
-{"id": "cite-1", "title": "TianShu GitHub Repository", "url": "https://github.com/bytedance/tian-shu", "snippet": "..."}
-...（共 7 条 JSONL）
-</citations>
