...
#   deploy/helm/tian-shu/Chart.yaml    (version: + appVersion:)
#
...
CHART="$ROOT/deploy/helm/tian-shu/Chart.yaml"
...
# deploy/helm/tian-shu/Chart.yaml — version: X.Y.Z and appVersion: "X.Y.Z"
...
echo "  deploy/helm/tian-shu/Chart.yaml (version + appVersion)"
echo
