...
from tianshu.agents.lead_agent.agent import build_middlewares
...
logging.getLogger("tianshu.agents.middlewares.tool_error_handling_middleware").setLevel(logging.CRITICAL)
