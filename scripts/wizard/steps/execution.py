...
LOCAL_SANDBOX = "tianshu.sandbox.local:LocalSandboxProvider"
CONTAINER_SANDBOX = "tianshu.community.aio_sandbox:AioSandboxProvider"
...
def run_execution_step(step_label: str = "Step 3/4") -> ExecutionStepResult:
    ...
    print_info("Choose how much execution power TianShu should have in this workspace.")
