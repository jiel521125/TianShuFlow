#!/usr/bin/env python3
"""Collect Kubernetes sandbox pod memory snapshots for TianShu.
...
DEFAULT_NAMESPACE = "tian-shu"
DEFAULT_SELECTOR = "app=tian-shu-sandbox"
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        "# TianShu Sandbox Memory Profile",
        "",
